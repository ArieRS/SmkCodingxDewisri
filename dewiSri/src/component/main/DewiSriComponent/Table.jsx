  ...
  return (
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography className={classes.title} variant="h6" id="tableTitle" component="div" style={{fontSize: '16px'}}>
          {tab}
        </Typography>
      )}
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar numSelected={selected.length} tab={props.tab} />
        <TableContainer>
          <Table
