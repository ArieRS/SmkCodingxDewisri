            ...
            <div className="profile-sidebar">
                ...
                <div className="profile" style={{ borderBottom: '1px solid white' }}>
                    ...
                    <div className="user-detail">
                        <h2>{this.props.state.userData.name}</h2>
                        <h3>{this.props.state.userData.isPremium ? 'Premium member' : 'Free member'}</h3>
                        {/* <p>Pria 50thn</p> */}
                        {/* <p>{this.props.state.journalDataByDate[0].plantList.length}
                ...
                <nav id="nav-menu-container">
                    <ul className="nav-menu">
                        {
                            this.props.state.userData.isPremium ? <></>
                                :
