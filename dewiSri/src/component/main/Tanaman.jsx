            ...
            <div className="container">
                <div id="carouselExampleControls" className="carousel slide" data-ride="carousel" data-interval="false">
                    <div className="carousel-inner">
                        ...
                        <div className="carousel-item">
                            <PanelTanaman tanaman="padi" komoditas="granola jerman" hari="100" />
                        </div>
                    </div>
                    <div className="button-wrapper mt-2 float-right">
                        <a className="btn btn-custom mr-1" href="#carouselExampleControls" role="button" data-slide="prev">
                        ...
                        <a className="btn btn-custom mx-3" href="#carouselExampleControls" role="button" data-slide="next">
